...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE,
                      ...
                      fig.retina = NULL)
pckg <- c("actigraphr", "dplyr", "lubridate", "ggplot2")
inst <- suppressMessages(lapply(pckg, library, character.only = TRUE))
theme_set(theme_light())
```

The `actigraphr` package implements two non-wear detection algorithms: Troiano (Troiano et al. 2008) and Choi (Choi et al. 2011). For illustration, let's use GT3X+ / ActiSleep+ sample data taken from ActiGraph's [online documentation](https://actigraph.desk.com). See the [sleep vignette](detect-sleep.html) for details on reading AGD files and collapsing epochs.
