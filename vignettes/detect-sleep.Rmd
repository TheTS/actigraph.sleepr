...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE,
                      ...
                      fig.retina = NULL)
pckg <- c("actigraphr", "dplyr", "tidyr", "lubridate", "ggplot2")
inst <- suppressMessages(lapply(pckg, library, character.only = TRUE))
theme_set(theme_light() + 
            theme(title = element_text(size = 7)))
```

The `actigraphr` package implements three sleep detection algorithms: Sadeh (Sadeh, Sharkey, and Carskadon 1994), Cole-Kripke (Cole et al. 1992) and Tudor-Locke (Tudor-Locke et al. 2014). For illustration, let's use GT3X+ / ActiSleep+ sample data taken from ActiGraph's [online documentation](https://actigraph.desk.com).
